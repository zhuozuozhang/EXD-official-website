...
// var li = $(".down-li ul li");
// function hover(){
// 	li.mouseover(function(){
// 		li.css("box-shadow", "0px 16px 16px rgba(204, 201, 201, 0.1)");
// 		li.css("transform", "translate(2px,-2px)")
// 	});
// };
// setInterval("hover()",50);
// console.log(setInterval);
// li.mouseout(function(){
// 	li.css("box-shadow", "none");
// 	li.css("transform", "translate(0)")
// });
