...
//         console.log(len);
//         if(len>500&&len<1100){
//             $(".bianyuan img").css("box-shadow","0 15px 30px rgba(0,0,0,0.1)");
//             $(".bianyuan img").css("width","140%")
//             $(".bianyuan img").css("height","130%")
//             $(".bianyuan img").css("transtion","1s")
//             $(".bianyuan").css("top","42%")
//             $(".bianyuan").css("left","32%")          
//         }else{
//             $(".bianyuan img").css("box-shadow","none");
//             $(".bianyuan img").css("width","100%")
//             $(".bianyuan img").css("height","100%")
//             $(".bianyuan").css("top","43.4%")
//             $(".bianyuan").css("left","32.2%")
//         };
//     });

//点击显示蒙层，点击图片放大
$(".middle-mid img").click(function(){
    $(".toggle").show();
    $(".toggle .timg").show();
